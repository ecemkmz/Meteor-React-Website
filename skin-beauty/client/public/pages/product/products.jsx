...
//   const skinTypes = Array.from(new Set(data.products.map((product) => product.skin_type)));
...
//         <h4>Kategori<i className="bx bx-chevron-down" /></h4>
...
//           ))}
//         </ul>
//         <h4>Cilt Tipi<i className="bx bx-chevron-down" /></h4>
//         <ul className="skinTypeList">
//           {skinTypes.map((skinType) => (
//             <li>
//               <a
//                 href="#"
//                 className={selectedSkinType === skinType ? "selected" : ""}
...
//           ))}
//         </ul>
//         <h4>Marka<i className="bx bx-chevron-down" /></h4>
            ...
            <div className="categoryHeading">
              <h6 className="categoryTitle">
                <a onClick={() => handleChevronClick(0)}>
                  <i className="bx bx-chevron-down" />Ürün Çeşidi
                </a>
              </h6>
            </div>
